...
.method private final g()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lqh;
    ...
    invoke-virtual {v2}, Lqh;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Lqh;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Lqh;->getTooltipText()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lqh;

    invoke-virtual {v0}, Lqh;->getTitle()Ljava/lang/CharSequence;
...
.method public final a(Lqh;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lqh;
    ...
    invoke-virtual {p1}, Lqh;->getItemId()I
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lug;

    if-nez p1, :cond_4

    new-instance p1, Lpp;

    invoke-direct {p1, p0}, Lpp;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lug;
...
.method public final d()Z
    ...
    invoke-virtual {v0}, Lqh;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lqf;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->a:Lqh;

    invoke-interface {p1, v0}, Lqf;->a(Lqh;)Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Ltd;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected final onMeasure(II)V
    ...
    invoke-super {p0, v1, v2, v3, v4}, Ltd;->setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, v0, v1}, Ltd;->setPadding(IIII)V
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1}, Ltd;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lqh;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Lug;
    ...
    :cond_0
    invoke-super {p0, p1}, Ltd;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public final setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Ltd;->setPadding(IIII)V
