...
# instance fields
.field public final mLifecycleOwner:Lz;
...
.method constructor <init>(Lz;Las;)V
    .locals 0

    invoke-direct {p0}, Landroid/support/v4/app/LoaderManager;-><init>()V

    iput-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLifecycleOwner:Lz;

    invoke-static {p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;->getInstance(Las;)Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;
...
.method private createAndInstallLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;Lhg;)Lhg;
    .locals 2
    ...
    invoke-interface {p3, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Lhg;
    ...
    invoke-direct {v1, p1, p2, v0, p4}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;-><init>(ILandroid/os/Bundle;Lhg;Lhg;)V
    ...
    iget-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLifecycleOwner:Lz;

    invoke-virtual {v1, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->setCallback(Lz;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Lhg;
...
.method public destroyLoader(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->destroy(Z)Lhg;
...
.method public getLoader(I)Lhg;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->getLoader()Lhg;
...
.method public initLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Lhg;
    .locals 4
    ...
    invoke-virtual {v0, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->setCallback(Lz;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Lhg;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroid/support/v4/app/LoaderManagerImpl;->createAndInstallLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;Lhg;)Lhg;
...
.method public restartLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Lhg;
    .locals 2
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLifecycleOwner:Lz;
