...
.method constructor <init>(Liee;Lifa;)V
    ...
    iput-object p1, p0, Liel;->b:Liee;

    iput-object p2, p0, Liel;->a:Lifa;
...
.method public final RgbReady(JLcom/google/googlex/gcam/InterleavedReadViewU8;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "Gouda debug image (rgb): id = "
    ...
    iget-object p4, p0, Liel;->a:Lifa;

    if-eqz p4, :cond_2

    iget-object p4, p0, Liel;->b:Liee;

    iget-object p4, p4, Liee;->i:Lcom/google/googlex/gcam/clientallocator/MapInterleavedU8ClientAllocator;
    ...
    invoke-interface/range {v0 .. v5}, Lifa;->b(JLcom/google/googlex/gcam/InterleavedReadViewU8;Lifb;Ljava/lang/String;)V
