...
.field private final h:Loet;

.field private final i:Lmpi;
...
# direct methods
.method constructor <init>(Lmmp;Lmmq;Ljava/util/Set;Lmpi;Llzp;Llzj;)V
    .locals 1
    ...
    iput-object v0, p0, Lmlz;->l:Landroid/hardware/camera2/params/StreamConfigurationMap;

    iput-object p1, p0, Lmlz;->g:Lmmp;

    iput-object p2, p0, Lmlz;->f:Lmmq;

    invoke-static {p3}, Loet;->a(Ljava/util/Collection;)Loet;

    move-result-object p1

    iput-object p1, p0, Lmlz;->h:Loet;

    iput-object p4, p0, Lmlz;->i:Lmpi;

    iput-object p5, p0, Lmlz;->j:Llzp;
    ...
    iput-object p1, p0, Lmlz;->k:Llzj;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lmlz;->e:Ljava/lang/Object;
...
.method private final F()Landroid/hardware/camera2/params/StreamConfigurationMap;
    ...
    iget-object v0, p0, Lmlz;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lmlz;->l:Landroid/hardware/camera2/params/StreamConfigurationMap;
    :try_end_0
    ...
    :try_start_1
    iget-object v1, p0, Lmlz;->j:Llzp;

    iget-object v2, p0, Lmlz;->g:Lmmp;
    ...
    invoke-virtual {p0, v1}, Lmlz;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/hardware/camera2/params/StreamConfigurationMap;

    iput-object v1, p0, Lmlz;->l:Landroid/hardware/camera2/params/StreamConfigurationMap;
    :try_end_1
    ...
    :goto_0
    invoke-interface {v2, v3, v1}, Llzj;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
...
.method public final C()Z
    ...
    invoke-virtual {p0}, Lmlz;->f()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0}, Lmlz;->b()Lmmt;
...
.method public final D()Ljava/util/List;
    ...
    invoke-interface {v0, v1}, Lmmq;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final E()I
    ...
    invoke-virtual {p0, v0}, Lmlz;->b(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final a(ILlyw;)J
    .locals 1

    invoke-direct {p0}, Lmlz;->F()Landroid/hardware/camera2/params/StreamConfigurationMap;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-static {p2}, Llyx;->b(Llyw;)Landroid/util/Size;
...
.method public final a(I)Ljava/util/List;
    ...
    invoke-static {p1}, Llyx;->a([Landroid/util/Size;)Ljava/util/List;
...
.method public final a()Lmmp;
    ...
    iget-object v0, p0, Lmlz;->g:Lmmp;

    return-object v0
.end method

.method public final a_(Llyw;)Ljava/util/List;
    .locals 1
    ...
    :cond_0
    invoke-static {p1}, Llyx;->b(Llyw;)Landroid/util/Size;
...
.method public final c()Ljava/util/List;
    ...
    invoke-static {v0}, Llyx;->a([Landroid/util/Size;)Ljava/util/List;
...
.method public final f()Z
    ...
    invoke-virtual {p0, v0, v1}, Lmlz;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final h()Lmms;
    ...
    invoke-static {v4}, Lmms;->a(I)Lmms;
...
.method public final i()Ljava/util/List;
    ...
    invoke-static {v0}, Loxl;->c([F)Ljava/util/List;
...
.method public final j()Z
    ...
    invoke-virtual {p0, v0}, Lmlz;->a(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final t()Ljava/util/List;
    ...
    sget-object v1, Lmlz;->c:[Landroid/util/Size;
...
.method public final w()[B
    ...
    sget-object v0, Lmlz;->d:[B

    sget-object v1, Lkvf;->a:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v1, :cond_0

    sget-object v0, Lkvf;->a:Landroid/hardware/camera2/CameraCharacteristics$Key;

    sget-object v1, Lmlz;->d:[B
...
.method public final x()Z
    ...
    :try_start_0
    invoke-virtual {p0}, Lmlz;->z()Ljava/util/Set;
