...
.method public constructor <init>(IIILcom/google/googlex/gcam/SWIGTYPE_p_float;J)V
    ...
    invoke-static/range {v0 .. v6}, Lcom/google/googlex/gcam/GcamModuleJNI;->new_InterleavedReadViewF__SWIG_4(IIIJJ)J

    move-result-wide p1

    const/4 p3, 0x1

    invoke-direct {p0, p1, p2, p3}, Lcom/google/googlex/gcam/InterleavedReadViewF;-><init>(JZ)V
...
.method public constructor <init>(Lcom/google/googlex/gcam/InterleavedReadViewF;)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/google/googlex/gcam/InterleavedReadViewF;-><init>(JZ)V
...
.method public declared-synchronized delete()V
    ...
    iget-boolean v4, p0, Lcom/google/googlex/gcam/InterleavedReadViewF;->swigCMemOwn:Z

    if-eqz v4, :cond_0

    const/4 v4, 0x0

    iput-boolean v4, p0, Lcom/google/googlex/gcam/InterleavedReadViewF;->swigCMemOwn:Z
    ...
    iput-wide v2, p0, Lcom/google/googlex/gcam/InterleavedReadViewF;->swigCPtr:J
    :try_end_0
...
.method public sample_iterator()Lcom/google/googlex/gcam/SWIGTYPE_p_gcam__TImageSampleIteratorT_float_const_gcam__kPixelContiguous_t;
    ...
    iget-wide v1, p0, Lcom/google/googlex/gcam/InterleavedReadViewF;->swigCPtr:J

    invoke-static {v1, v2, p0}, Lcom/google/googlex/gcam/GcamModuleJNI;->InterleavedReadViewF_sample_iterator__SWIG_0(JLcom/google/googlex/gcam/InterleavedReadViewF;)J

    move-result-wide v1

    const/4 v3, 0x1

    invoke-direct {v0, v1, v2, v3}, Lcom/google/googlex/gcam/SWIGTYPE_p_gcam__TImageSampleIteratorT_float_const_gcam__kPixelContiguous_t;-><init>(JZ)V
...
.method public sample_iterator(I)Lcom/google/googlex/gcam/SWIGTYPE_p_gcam__TImageSampleIteratorT_float_const_gcam__kPixelContiguous_t;
    ...
    invoke-static {v1, v2, p0, p1}, Lcom/google/googlex/gcam/GcamModuleJNI;->InterleavedReadViewF_sample_iterator__SWIG_1(JLcom/google/googlex/gcam/InterleavedReadViewF;I)J

    move-result-wide v1

    const/4 p1, 0x1

    invoke-direct {v0, v1, v2, p1}, Lcom/google/googlex/gcam/SWIGTYPE_p_gcam__TImageSampleIteratorT_float_const_gcam__kPixelContiguous_t;-><init>(JZ)V
