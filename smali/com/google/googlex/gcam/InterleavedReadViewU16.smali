...
.method public constructor <init>(IIILcom/google/googlex/gcam/SWIGTYPE_p_unsigned_short;J)V
    ...
    invoke-static/range {v0 .. v6}, Lcom/google/googlex/gcam/GcamModuleJNI;->new_InterleavedReadViewU16__SWIG_4(IIIJJ)J

    move-result-wide p1

    const/4 p3, 0x1

    invoke-direct {p0, p1, p2, p3}, Lcom/google/googlex/gcam/InterleavedReadViewU16;-><init>(JZ)V
...
.method public constructor <init>(Lcom/google/googlex/gcam/InterleavedReadViewU16;)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/google/googlex/gcam/InterleavedReadViewU16;-><init>(JZ)V
...
.method public declared-synchronized delete()V
    ...
    iget-boolean v4, p0, Lcom/google/googlex/gcam/InterleavedReadViewU16;->swigCMemOwn:Z

    if-eqz v4, :cond_0

    const/4 v4, 0x0

    iput-boolean v4, p0, Lcom/google/googlex/gcam/InterleavedReadViewU16;->swigCMemOwn:Z
    ...
    iput-wide v2, p0, Lcom/google/googlex/gcam/InterleavedReadViewU16;->swigCPtr:J
    :try_end_0
...
.method public sample_iterator()Lcom/google/googlex/gcam/SWIGTYPE_p_gcam__TImageSampleIteratorT_unsigned_short_const_gcam__kPixelContiguous_t;
    ...
    iget-wide v1, p0, Lcom/google/googlex/gcam/InterleavedReadViewU16;->swigCPtr:J

    invoke-static {v1, v2, p0}, Lcom/google/googlex/gcam/GcamModuleJNI;->InterleavedReadViewU16_sample_iterator__SWIG_0(JLcom/google/googlex/gcam/InterleavedReadViewU16;)J

    move-result-wide v1

    const/4 v3, 0x1

    invoke-direct {v0, v1, v2, v3}, Lcom/google/googlex/gcam/SWIGTYPE_p_gcam__TImageSampleIteratorT_unsigned_short_const_gcam__kPixelContiguous_t;-><init>(JZ)V
...
.method public sample_iterator(I)Lcom/google/googlex/gcam/SWIGTYPE_p_gcam__TImageSampleIteratorT_unsigned_short_const_gcam__kPixelContiguous_t;
    ...
    invoke-static {v1, v2, p0, p1}, Lcom/google/googlex/gcam/GcamModuleJNI;->InterleavedReadViewU16_sample_iterator__SWIG_1(JLcom/google/googlex/gcam/InterleavedReadViewU16;I)J

    move-result-wide v1

    const/4 p1, 0x1

    invoke-direct {v0, v1, v2, p1}, Lcom/google/googlex/gcam/SWIGTYPE_p_gcam__TImageSampleIteratorT_unsigned_short_const_gcam__kPixelContiguous_t;-><init>(JZ)V
